...
| 3 | Marketing — Disciplines & jurisdictions section | Showed 4 disciplines and 4 jurisdictions; PRD has 11 disciplines with live/roadmap states and "Yours — author it" | Prompt issued (19 Sept) | Approved — 24 Sept export: Home "Disciplines and jurisdictions" lists all 11 disciplines (Architecture live, 10 marked roadmap), Generic and "Yours — author it" |
