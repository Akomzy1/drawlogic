...
1. `docs/PRD.md` (v0.2.10) — §6 principles, §7.4 Check, §7.6 Render, §5A (3D, generative video, narration), FR-06–09 construction defaults, **§8A model allocation**, Appendices A–B.
